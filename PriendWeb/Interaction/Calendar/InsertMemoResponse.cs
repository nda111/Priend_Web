    ...
    public sealed class InsertMemoResponse : IResponse
    {
        ...
        {            
            ...
            using (var cmd = npgConn.CreateCommand())
            {
                ...
                {
                    cmd.CommandText = $"INSERT animal_id, date_time, title, content INTO memo VALUES({memo.Id}, {memo.When}, '{memo.Title}', '{memo.Content}');";
                }
                else
                {
                    cmd.CommandText = $"INSERT animal_id, date_time, title, content, images INTO memo VALUES({memo.Id}, {memo.When}, '{memo.Title}', '{memo.Content}', '{memo.PhotoString}');";
                }
